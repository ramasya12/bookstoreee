<div class="row text-center">
	...
	if(isset($_GET['search_book'])){
		if($_GET['search_book']==""){
			$all=mysql_query($conn, "SELECT * FROM tb_produk, tb_kategori WHERE tb_kategori.id_kategori=tb_produk.id_kategori ORDER BY id_produk ASC");
		}
		else{
		...
		<div class="card" id="<?php echo $id_produk;?>">
			...
			<div class="card-footer">
	            ...
	            if(isset($_SESSION['id'])){
	            	echo "<button name=\"add_cart\" type=\"submit\" class=\"btn btn-primary\" id=\"add\">Beli</button>";
	            }
	            else{
	                echo "<a href=\"\" onClick=\"onCartClick()\" class=\"btn btn-primary\">Beli</a>";
	            }
	            ?>
			</div>
		</div>
