...
if(isset($_POST['edit_produk'])) {
    ...
    $hasil=mysqli_query("UPDATE tb_produk SET nama_buku='$nama_buku' ,id_kategori='$id_kategori', pengarang='$pengarang', harga='$harga', image_buku='$image_buku' WHERE id_produk='$id_produk'");
    if($hasil){
        header("location:manage.php?page=produk");
    }
}
                    ...
                    <div class="control-group form-group">
                        <div class="controls">
                            ...
                            <select name="id_kategori" class="form-control" id="kategori">
                                ...
                                $cat=mysqli_query("SELECT * FROM tb_kategori");
