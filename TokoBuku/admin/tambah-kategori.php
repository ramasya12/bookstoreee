...
if(isset($_GET['id_kategori'])) {
    ...
    $hasil=mysqli_query("SELECT * FROM tb_kategori WHERE id_kategori='$id_kategori'");
...
if(isset($_POST['edit_kategori'])) {
    ...
    $hasil=mysqli_query("UPDATE tb_kategori SET nama_kategori='$kategori' WHERE id_kategori='$id_kategori'");
    if($hasil){
        header("location:manage.php?page=kategori");
    }
}
